...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        interface_2->setMinimumSize(QSize(350, 0));
        interface_2->setMaximumSize(QSize(400, 1600000));
        ...
        start->setMinimumSize(QSize(80, 30));
        QFont font;
        ...
        horizontalWidget_4->setMaximumSize(QSize(16777215, 40));
        ...
        timerStart->setMinimumSize(QSize(80, 30));
        ...
        timerPause->setMinimumSize(QSize(80, 30));
        timerPause->setFont(font);
        ...
        timerStop->setMinimumSize(QSize(80, 30));
        timerStop->setFont(font);
